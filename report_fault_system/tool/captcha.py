...
class Captcha(object):
    ...
    def __init__(self, width=160, height=60, fonts=None, font_sizes=None):
        self._width = width
        self._height = height
        self._fonts = fonts or [r'arial.ttf']
    ...
    def generate_captcha(self):
        ...
        # 生成文字
        random_str = ''.join(random.sample(self.characters, n_len))
        # # 字体集合
        # fonts = [os.path.join(r'C:\Windows\Fonts', font) for font in
        #          ['arial.ttf', 'Carlito-Regular.ttf', 'DejaVuSans.ttf']]
        # 字体大小集合
        font_sizes = range(40, 50)
        # 生成图片
        generator = Captcha(width=width, height=height, font_sizes=font_sizes)
